...
namespace GalponERP.Infrastructure.Migrations
{
    ...
    [Migration("20260415181814_AddStockActualAndRecommendedQuantity")]
    partial class AddStockActualAndRecommendedQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.PagoVenta", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Monto", "GalponERP.Domain.Entities.PagoVenta.Monto#Moneda", b1 =>
                        {
                            b1.IsRequired();
