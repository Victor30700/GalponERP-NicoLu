...
namespace GalponERP.Infrastructure.Migrations
{
    ...
    [Migration("20260421035425_BlindajeSistemaFases1_4")]
    partial class BlindajeSistemaFases1_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.InventarioLote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.Lote", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaFinRetiro")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.MovimientoInventario", b =>
                {
                    ...
                    b.Property<Guid?>("InventarioLoteId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.Producto", b =>
                {
                    ...
                    b.Property<int>("PeriodoRetiroDias")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.RegistroBienestar", b =>
                {
                    ...
                    b.Property<decimal?>("LecturaMedidor")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("GalponERP.Domain.Entities.MovimientoInventario", b =>
                {
                    ...
                    b.HasOne("GalponERP.Domain.Entities.InventarioLote", "InventarioLote")
                        .WithMany()
                        .HasForeignKey("InventarioLoteId");
