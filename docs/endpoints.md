...
```json
{
  ...
  "galponId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
  "loteId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
  "descripcion": "Pago Luz Abril Actualizado",
  "monto": 50.00,
  "moneda": "USD",
  "fecha": "2026-04-10T00:00:00Z",
  "tipoGasto": "Servicios"
...
### Verificar Niveles al Alimento
... (rest of the endpoint content) ...
```

### Obtener Reporte de Movimientos de Inventario (Kardex Avanzado)
...
- **Query Params:**
  ...
  - `categoriaProductoId` (Guid, opcional)
- **Salida (JSON):**
```json
[
  {
...
minación en catálogos utilizan el patrón `IsActive = false` heredado de la clase base `Entity`.
